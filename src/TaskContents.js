        ...
        <div className="task-contents container">
            <div className="row mb-2 menu menu-vid">
                <Link to={`/video/${task_id}`}>
                    <h1 className="text-dark"><i className="fas fa-video"></i> Recording Video</h1>
                </Link>
            </div>
            <div className="row mb-2 menu menu-doc">
                <a href={`${document.documentUrl}`} target="_blank" rel="noreferrer">
                    <h1 className="text-dark"><i className="far fa-file-pdf"></i> Reading Material</h1>
                </a>
            </div>
            <div className="row mb-2 menu menu-links">
                <Link to={`/link/${task_id}`}>
                    <h1 className="text-dark"><i className="fas fa-paperclip"></i> Link</h1>
                </Link>
            </div>
